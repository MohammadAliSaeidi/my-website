...
export const SkillsData = [
	...
	},
	{
		...
		description: 'Practical knowledge on concepts like User story, Epics, Sprints, Backlog, Project Management. Experienced in calculating estimated time for tasks using formula. Experiences participating in meetings to plan and prioritize tasks.',
		icon: <AgileIcon/>,
		id: 4
	},
	{
